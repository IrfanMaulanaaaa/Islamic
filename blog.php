<?php
        ...
        $sql = "SELECT blogs.title, blogs.content, blogs.created_at, blogs.image_path, admin.nama 
        FROM blogs 
        JOIN admin ON blogs.user_id = admin.id";
    ...
    <body>
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h3 class="text-white display-3 mb-4 wow fadeInDown" data-wow-delay="0.1s">Islamic Center Blog</h1>
        ...
        <div class="container-fluid blog py-5">
            <div class="container py-5">
                <div class="section-title mb-5 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="display-3 mb-4">Mengenai Event, Bazar, Pameran, dan lain lain.</h1>
                ...
                if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo '    <div class="blog-item rounded">';
                        echo '        <div class="blog-img">';
                        echo '            <img src="' . htmlspecialchars($row["image_path"]) . '" class="img-fluid w-100" alt="Image">';
                        echo '        </div>';
                        echo '        <div class="blog-centent p-4">';
                        echo '            <div class="d-flex justify-content-between mb-4">';
                        echo '                <p class="mb-0 text-muted"><i class="fa fa-calendar-alt text-primary"></i> ' . date("d M Y", strtotime($row["created_at"])) . '</p>';
                        echo '                <a href="#" class="text-muted"><span class="fa fa-comments text-primary"></span> ' . htmlspecialchars($row["nama"]) . '</a>';
                        echo '            </div>';
                        echo '            <a href="#" class="h4">' . htmlspecialchars($row["title"]) . '</a>';
                        echo '            <p class="my-4">' . htmlspecialchars($row["content"]) . '</p>';
                        echo '            <a href="#" class="btn btn-primary rounded-pill text-white py-2 px-4 mb-1">Read More</a>';
                        echo '        </div>';
                        echo '    </div>';
                        echo '</div>';
                    }
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="blog-item rounded">
                            ...
                            <div class="blog-centent p-4">
                                ...
                                <p class="my-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde totam vitae aut quaerat veniam natus ut, fugit quo magnam, alias fuga fugiat et impedit corrupti sunt dicta aliquam aperiam vel assumenda sit odit. Rerum in, odio exercitationem excepturi nemo debitis aliquid quo, maxime vel ad, sit deleniti? Consectetur, vitae! Magnam mollitia vero tenetur voluptate numquam eveniet enim animi beatae cumque soluta, provident harum impedit, quidem suscipit quasi? Dolores porro, ducimus quae voluptate expedita et odio laudantium illum tenetur deserunt blanditiis cupiditate iure, cumque, molestiae temporibus perspiciatis. Accusantium odit quaerat blanditiis, nam architecto eos quod sapiente quia ducimus, aliquid ut sit.,</p>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        var previews = document.querySelectorAll(".my-4");
        var maxChars = 200; 
        var maxLines = 5; 
